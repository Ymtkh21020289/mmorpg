...
const DROP_TABLE = {
    ...
    'king_slime': { money: 500, items: [{ id: 'slime_gel', rate: 0.99 }, { id: 'slime_sword', rate: 0.05 }, { id: 'magic_stone', rate: 0.5 }, { id: 'kingSlime_heart', rate: 0.01}]},
    'fairy': { money: 500, items: [{ id: 'mathili_gun', rate: 0.01 }]}
};
